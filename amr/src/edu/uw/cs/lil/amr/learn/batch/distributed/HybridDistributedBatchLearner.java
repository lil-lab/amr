...
/**
 * Distributed learner with batch lexical induction and online (non-distributed)
 * parameter estimation. Each iteration includes a batch fully distributed
 * lexical generation pass and an online parameter estimation pass.
 *
 * @author Yoav Artzi
 */
public class HybridDistributedBatchLearner
		extends AbstractDistributedBatchLearner {

	public HybridDistributedBatchLearner(int numIterations,
	...
	public static class Creator
			implements IResourceObjectCreator<HybridDistributedBatchLearner> {

		private final String type;

		public Creator() {
			this("learner.amr.hybridbatch.dist");
		}
